...
class AdminPagesController extends AdminController {
	...
	public function postEdit($id = null) {
		...
		return view('admin::pages.edit', [
            'stockItemIds' => $page->stock_items()->pluck('id')->all(),
            'page' => $page,
            'pages' => $pages,
	...
	public function postSave() {
		$id = Request::get('id');
		$data = Request::except(['setting', 'setting_group', 'stock_items']);
        ...
        $page->stock_items()->sync($stockItemIds);

        return $redirect
            ? ['redirect' => route('admin.pages.edit', [$page->id])]
            : ['success' => true, 'msg' => 'Изменения сохранены', 'row' => view('admin::pages.tree_item', ['item' => $page])->render()];
	}
