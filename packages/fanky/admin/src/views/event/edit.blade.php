...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.event') }}">События</a></li>
        <li class="active">{{ $article->id ? 'Редактировать' : 'Новая' }}</li>
    </ol>
@stop

@section('content')
    <form action="{{ route('admin.event.save') }}" onsubmit="return newsSave(this, event)">
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_1">
                    ...
                    {!! Form::groupText('h1', $article->h1, 'H1') !!}
                    ...
                    <div class="form-group">
                        ...
                        <div id="article-image-block">
                            @if ($article->image)
                                ...
                                <a class="images_del" href="{{ route('admin.event.delete-image', [$article->id]) }}" onclick="return newsImageDel(this, event)">
                    ...
                    {!! Form::groupCheckbox('published', 1, $article->published, 'Показывать событие') !!}
                </div>
